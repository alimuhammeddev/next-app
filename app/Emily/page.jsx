      ...
      <div>
        ...
        >
          <div className="flex items-center gap-1">
            ...
            <p className="font-semibold">Engage with Emily Lewis</p>
          </div>
          <h1>
            Emily may be interested in upgrading EL Stores to suit customers'
            expectations.
          </h1>
        </div>
        ...
        {isPopupOpen && (
          <div className="fixed inset-0 bg-gray-500 bg-opacity-10 z-10 flex justify-center items-center">
            <div className="bg-white p-5 rounded-lg shadow-lg relative">
              ...
              <h2 className="font-semibold mt-2">About Emily</h2>
              <p>
